...
// DLSuit
#define COCOAPODS_POD_AVAILABLE_DLSuit
#define COCOAPODS_VERSION_MAJOR_DLSuit 0
#define COCOAPODS_VERSION_MINOR_DLSuit 1
#define COCOAPODS_VERSION_PATCH_DLSuit 0
